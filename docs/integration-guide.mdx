...
- Share access to your data with Kubit through one of the integration approaches.
  - Average duration 1 hour - 2 days (_This is heavily dependent on the integration method you select_.)
...
_Implementation of ETL (Extract, Transform and Load) to populate the star schema from your transactional data is out of the scope for this guide. Though feel free to contact Kubit support to get additional information or advice on this topic._
